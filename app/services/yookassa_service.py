...
пакета или без настроенного магазина. Сетевые вызовы SDK синхронные, поэтому
выполняем их в пуле потоков, чтобы не блокировать event loop.
"""
...
class YooKassaError(RuntimeError):
    """Платёжный провайдер не настроен или вернул ошибку."""
